        ...
        <div class="card mb-5">
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800">04/05/2003</span></div>
                </div>
                
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Gender</label>
                    <div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800">Male</span></div>
                </div>
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800">09/11/2017</span></div>
                </div>

                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Place of issue</label>
                    <div class="col-lg-8"><span class="fw-bold fs-6 text-gray-800">TP. Hồ Chí Minh</span></div>
                </div>
            </div>
        </div>
    </div>
